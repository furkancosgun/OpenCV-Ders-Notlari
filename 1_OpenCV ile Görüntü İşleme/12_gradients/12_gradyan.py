...
# x gradyan
#değişken=sobel fonk(resmimiz,output derinligi,x yonunde ,y yonunde,koşe sayısı)
sobelx = cv2.Sobel(img, ddepth = cv2.CV_16S, dx = 1, dy = 1, ksize = 5)
...
# laplacian gradyan her ikisinide verir
